#!/usr/bin/env bash
# REST end-to-end check: seeds a demo domain into a running origoad and
...
h=json.load(sys.stdin)['history']; assert any('moved' in e['subject'] for e in h) and h[-1]['trailers']['Origoa-Op']=='create', h"
